  ...
  return (
    <div>
      ...
      <Section title="1 · Create an agent key">
        <ol className="list-decimal space-y-3 pl-5 text-body-md leading-relaxed text-text-secondary">
      ...
      <Section title="3 · Add Anchor to your runtime">
        <div className="space-y-10">
          {runtimes.map((runtime) => (
            <div key={runtime.name}>
              <h3 className="font-body text-body-lg font-semibold text-text-primary">{runtime.name}</h3>
              <p className="mt-2 text-body-sm leading-relaxed text-text-secondary">{runtime.where}</p>
              <div className="mt-4">
                <CodeBlock code={runtime.code} />
              </div>
            </div>
          ))}
        </div>
        <p className="text-body-md leading-relaxed text-text-secondary">
          ...
          file differs. Replace <code className="code-inline">https://&lt;your-anchor-endpoint&gt;/mcp</code>{' '}
          with the Anchor endpoint shown in your dashboard, and{' '}
          <code className="code-inline">&lt;your-agent-key&gt;</code> with the key you created.
        </p>
      </Section>
